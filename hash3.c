...
void phi(const uint8_t *Hj_11, const uint8_t *Hj_12, const uint8_t *Hj_13, const uint8_t *Hj_14,
         const uint8_t *Hj_15, const uint8_t *Hj_16, const uint8_t *Hj_17, const uint8_t *Hj_18,
         const uint8_t *Dj1, const uint8_t *Dj2, const uint8_t *Dj3, const uint8_t *Dj4,
         uint8_t *Hj1, uint8_t *Hj2, uint8_t *Hj3, uint8_t *Hj4,
         uint8_t *Hj5, uint8_t *Hj6, uint8_t *Hj7, uint8_t *Hj8)
{
    uint8_t Xj1[16], Xj2[16], Xj3[16], Xj4[16], Xj5[16], Xj6[16], Xj7[16], Xj8[16];
    uint8_t Yj1[16], Yj2[16], Yj3[16], Yj4[16], Yj5[16], Yj6[16], Yj7[16], Yj8[16];
    gamma1(Hj_11, Hj_12, Hj_13, Hj_14, Hj_15, Hj_16, Hj_17, Hj_18,
           Dj1, Dj2, Dj3, Dj4,
           Xj1, Xj2, Xj3, Xj4, Xj5, Xj6, Xj7, Xj8,
           Yj1, Yj2, Yj3, Yj4, Yj5, Yj6, Yj7, Yj8);
...
void T(const uint8_t *Hq1, const uint8_t *Hq2, const uint8_t *Hq3, const uint8_t *Hq4,
       const uint8_t *Hq5, const uint8_t *Hq6, const uint8_t *Hq7, const uint8_t *Hq8,
       uint8_t *H)
{
    uint8_t D1[16], D2[16], D3[16], D4[16];
    uint8_t Hj1[16], Hj2[16], Hj3[16], Hj4[16], Hj5[16], Hj6[16], Hj7[16], Hj8[16];
...
void h(const uint8_t *D, int D_len, const uint8_t *IV, uint8_t *H)
{
    ...
    for (int i = 1; i < q; i++)
    {
        phi(Hj1, Hj2, Hj3, Hj4, Hj5, Hj6, Hj7, Hj8, D + 64 * i, D + 64 * i + 16, D + 64 * i + 16 * 2, D + 64 * i + 16 * 3,
            Hj1, Hj2, Hj3, Hj4, Hj5, Hj6, Hj7, Hj8);
        printf("j=%d,Hj:\n", i + 1);
        memory_dump(Hj1, 16);
        memory_dump(Hj2, 16);
    ...
    T(Hj1, Hj2, Hj3, Hj4, Hj5, Hj6, Hj7, Hj8, H);
}